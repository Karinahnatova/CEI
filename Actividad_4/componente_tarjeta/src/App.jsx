  ...
  let fruits = [
    {
      ...
      children: "Fresa importada de Alemania, muy dulce y sabrosa, por solo 5€ el kg",
    },
    {
      id: "manzana",
      ...
      children: "Manzana importada de Colombia, muy dulce y sabrosa, por solo 2€ el kg",
    },
    {
      id: "banana",
      ...
      children: "Banana importada de Africa, de la mejor calidad, por solo 2,40€ el kg",
    },
    {
      id: "mora",
      nombre: "Mora",
      ...
      children: "Moras de la huerta Valenciana, muy sabrosas y deliciosas, por solo 6€ el kg",
    },
    {
      id: "frambuesa",
      nombre: "Frambuesa",
      ...
      children: "Frambuesas de la huerta Valenciana, muy sabrosas y deliciosas, por solo 5,80€ el kg",
    },
  ];
